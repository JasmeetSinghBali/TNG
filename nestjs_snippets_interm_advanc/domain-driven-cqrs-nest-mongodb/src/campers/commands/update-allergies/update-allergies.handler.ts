...
import { CamperEntityRepository } from "src/campers/db_related_operations/camper-entity.repository";
...
export class UpdateAllergiesHandler implements ICommandHandler<UpdateAllergiesCommand>{
    constructor(private readonly camperEntityRepository: CamperEntityRepository, private readonly eventPublisher: EventPublisher){}
